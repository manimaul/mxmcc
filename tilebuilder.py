...
def _build_tile_vrt_for_map(map_path, cutline=None, verbose=False):
    ...
    t_srs = gdalds.dataset_get_as_epsg_900913(dataset)  # offset for crossing dateline
    s_srs = gdalds.dataset_get_projection_wkt(dataset)
    ...
    command = ['gdalwarp', '-of', 'vrt', '-r', resampling, '-s_srs', s_srs, '-t_srs', t_srs]
...
#     import bsb
#     #test_map = '/mnt/aux-drive/mxmcc/charts/noaa/BSB_ROOT/13297/13297_1.KAP'
#     test_map = '/mnt/aux-drive/mxmcc/charts/noaa/BSB_ROOT/530/530_1.KAP'
